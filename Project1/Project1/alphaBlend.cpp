...
int main()
{
	...
	Mat foreGroundImage = imread("../Resource/alphaBlending/foreGroundAssetLarge.png", -1); imshow("foreG", foreGroundImage);
	Mat bgra[4];
	...
	Mat foreground = Mat::zeros(foreGroundImage.size(), CV_8UC3); //新增Alpha层？
	...
	Mat background = imread("../Resource/alphaBlending/backGroundLarge.jpg");
	...
	double t = (double)getTickCount();  //获取时间
